...
module nios_uart_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                  // nios2_gen2_0_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire  [17:0] altpll_0_pll_slave_agent_m0_address;                                                // altpll_0_pll_slave_agent:m0_address -> altpll_0_pll_slave_translator:uav_address
	...
	wire  [93:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> altpll_0_pll_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [94:0] uart_0_s1_agent_rf_source_data;                                                     // uart_0_s1_agent:rf_source_data -> uart_0_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] uart_0_s1_agent_rsp_fifo_out_data;                                                  // uart_0_s1_agent_rsp_fifo:out_data -> uart_0_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> uart_0_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // uart_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire  [93:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [93:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [93:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire   [4:0] rsp_demux_001_src0_channel;                                                         // rsp_demux_001:src0_channel -> crosser_001:in_channel
	...
	wire   [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux:sink1_channel
	...
	nios_uart_mm_interconnect_0_router_003 router_004 (
	...
	nios_uart_mm_interconnect_0_router_002 router_005 (
	...
	nios_uart_mm_interconnect_0_router_003 router_006 (
	...
	nios_uart_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_uart_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_uart_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_uart_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_uart_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_uart_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
